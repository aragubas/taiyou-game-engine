...
namespace TaiyouGameEngine.Desktop.TextBox
{
    public class TextBox
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Sprite.GetSprite("Base.png"), new Rectangle(Area.X - 4, Area.Y - 4, Area.Width + 8, Area.Height + 8), null, Color.FromNonPremultiplied(0,0,0, Opacity - 50));
            spriteBatch.Draw(Sprite.GetSprite("Base.png"), new Rectangle(Area.X - 2, Area.Y - 2, Area.Width + 4, Area.Height + 4), null, Color.FromNonPremultiplied(20, 20, 20, Opacity));
            spriteBatch.Draw(Sprite.GetSprite("Base.png"), Area, null, Color.FromNonPremultiplied(50, 50, 50, Opacity));
