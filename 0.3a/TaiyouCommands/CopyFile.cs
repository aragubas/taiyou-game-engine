/*
   ...
   THE MONOGAME LICENSE IS IN THE2 MONOGAME_License.txt file on the root folder. 

   ####### END MONOGAME LICENSE ##22##### 
...
namespace TaiyouGameEngine.Desktop.TaiyouCommands
{
    public class CopyFile
    {
        ...
        public static void Initialize(string[] SplitedString)
        {
            ...
            if (SplitedString.Length < 2) { throw new Exception("CopyFile dont take less than 2 arguments."); }
            ...
            {
                File.Copy(DirectoryOfData + Arg1, DirectoryOfData + Arg2);
            }
            else
            {
