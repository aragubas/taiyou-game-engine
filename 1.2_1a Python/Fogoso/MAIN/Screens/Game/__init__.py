...
def LoadGame():
    ...
    for x in range(0, len([name for name in os.listdir("Fogoso/SOURCE/REG/Save/item/") if os.path.isfile(os.path.join("Fogoso/SOURCE/REG/Save/item/", name))])):
...
def UpdateSavingScreen(DISPLAY):
    ...
    SavingSurfaceBackground.fill((5, 4, 3))
    SavingSurfaceBackground.set_alpha(200 + BackgroundAnim_Numb)
    ...
    sprite.RenderFont(DISPLAY,"/PressStart2P.ttf", 50, SavingText, (250,250,255),TextSavingX, TextSavingY)
    sprite.RenderFont(DISPLAY,"/PressStart2P.ttf", 35, SavingPercentage, (250,250,255),DISPLAY.get_width() / 2 - sprite.GetText_width("/PressStart2P.ttf", 35, SavingPercentage) / 2, TextSavingY + 100)
