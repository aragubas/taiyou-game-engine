...
def GameDraw(DISPLAY):
    ...
    sprite.RenderRectangle(DISPLAY, (10, 20, 17), (ElementsX - 4, ElementsY - 4, 558, 258))
    sprite.RenderRectangle(DISPLAY, (30, 40, 47), (ElementsX, ElementsY, 550, 250))

    # -- Render The Title Text --
    sprite.RenderFont(DISPLAY, "/PressStart2P.ttf", 28, "-- Options --", (255, 255, 255), ElementsX + 95,
                      ElementsY + 5)
    # -- Render Close Button -- #
    ...
    sprite.RenderFont(DISPLAY, "/PressStart2P.ttf", 14, "Max FPS:" + str(gameMain.Engine_MaxFPS),
                      (255, 255, 255), ElementsX + 95, ElementsY + 52)
    ...
    sprite.RenderFont(DISPLAY, "/PressStart2P.ttf", 14,
                      ...
                      (255, 255, 255), ElementsX + 95, ElementsY + 78)
    ...
    sprite.RenderFont(DISPLAY, "/PressStart2P.ttf", 14, "Flash Animation Speed:" + str(gameMain.FadeEffectSpeed),
                      (255, 255, 255), ElementsX + 95, ElementsY + 102)
